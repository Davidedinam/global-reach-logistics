      ...
      <section className="bg-gradient-hero text-primary-foreground py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About Swift Shipping Company Limited</h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <div className="space-y-4 text-lg text-muted-foreground animate-slide-up">
                  <p>
                    Founded with a simple mission, Swift Shipping Company Limited strives to make international
              ...
              <div className="order-1 md:order-2 animate-fade-in">
                <img 
                  src={teamMeeting} 
                  alt="Swift Shipping team collaboration" 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Why Choose Swift Shipping?</h2>
